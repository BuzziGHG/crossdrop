...
## 📥 Downloads (Aktuelle Version 1.3.4)
...
| 🐧 **Linux (Debian / Ubuntu)** | Paket (`.deb`) | [⬇️ crossdrop_1.3.4_amd64.deb](https://github.com/BuzziGHG/crossdrop/releases/latest/download/crossdrop_1.3.4_amd64.deb) | [⚡ Direktdownload](http://82.29.5.240:2603/api/updates/download/linux) |
...
- 🔔 **Android Benachrichtigungs-Fix (Single Unified Notification):**
  - Behebt das Problem der doppelten Benachrichtigungen auf Android beim Minimieren/Schließen der App.
  - Auf Android übernimmt nun ausschließlich der native `TransferForegroundService` die dauerhafte Live-Fortschrittsanzeige.
  - Verhindert das Wiederaufploppen von Benachrichtigungen beim Wegwischen; nach Abschluss der Übertragung wird die laufende Service-Benachrichtigung sauber beendet und durch eine einmalige Erfolgsmeldung ersetzt.
- 🛠️ **In-App Update Download Fix (aus v1.3.3):**
  ...
  - Neuer **"Abbrechen"**-Button während des Downloads und Dialog schließbar (`barrierDismissible`).
